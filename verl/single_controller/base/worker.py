...
class Worker(WorkerHelper):
    ...
    def __init__(self, cuda_visible_devices=None) -> None:
        ...
        ray_local_rank = os.getenv("RAY_LOCAL_RANK")
        if os.getenv("LOCAL_RANK") is None and ray_local_rank is not None:
            os.environ["LOCAL_RANK"] = ray_local_rank

        ray_local_world_size = os.getenv("RAY_LOCAL_WORLD_SIZE")
        if os.getenv("LOCAL_WORLD_SIZE") is None and ray_local_world_size is not None:
